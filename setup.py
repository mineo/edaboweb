...
def update_version_py():
    ...
    try:
        ...
        print("unable to run git, leaving edaboweb/version.py alone")
        return
    ...
    if p.returncode != 0:
        ...
        return
    ver = stdout.strip()
    f = open("edaboweb/version.py", "w")
    f.write(VERSION_PY % ver)
    f.close()
    print("set edaboweb/version.py to '%s'" % ver)

def get_version():
    try:
        f = open("edaboweb/version.py")
    except IOError as e:
        import errno
...
class Version(Command):
    description = "update edaboweb/version.py from Git repo"
    user_options = []
    boolean_options = []
...
setup(name="edaboweb",
      ...
      packages=["edaboweb"],
      package_dir={"edaboweb": "edaboweb"},
      download_url=["https://github.com/mineo/edaboweb/tarball/master"],
      url=["http://github.com/mineo/edaboweb"],
      license="MIT",
